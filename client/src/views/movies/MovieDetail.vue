...
getpreview: function () {
    ...
    axios(
        {method: "GET", url: `https://api.themoviedb.org/3/movie/${this.$route.params.movieId}/videos?api_key=f9acc36e1794da31c1fa05368571a14c&language=en-US`, headers: this.setToken()}
    ).then(res => {
        if (res.data.results) {
            this.video_key = res
                .data
...
this
    .$store
    .dispatch('LoadMovieDetail', content)
this.getpreview()
},
