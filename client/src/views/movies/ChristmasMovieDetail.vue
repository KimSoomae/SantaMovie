    ...
    <div>
        <div class="wrapper">
            ...
            <div class="phone">
                <img
                    class="phoneBody"
                    src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/153207/Iphone2.png">
                    ...
                    <div class="mobileDisplay">
                        ...
                        <img
                            class="mobileInfo"
                            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/153207/iphoneHeader.png"
                            alt="">
                            ...
                            <div class="movie" v-bind:style="{backgroundImage: 'url(' + imgUrl + ')'} ">
                                ...
                                <svg
                                    ...
                                    d="M375.9 230.5L200.1 117.7c-5.3-3.4-12-3.6-17.5-.6s-8.9 8.8-8.9 15v225.5c0 6.3 3.4 12 8.9 15 2.6 1.4 5.4 2.1 8.2 2.1 3.2 0 6.4-.9 9.3-2.7l175.8-112.7c4.9-3.2 7.9-8.6 7.9-14.4-.1-5.8-3-11.3-7.9-14.4zm-168 95.8V163.5l126.9 81.4-126.9 81.4z"/></svg>
                            </div>
                            ...
                            <div class="movieDetails">
                                <div class="movieRating">
                                    ...
                                    <!-- HEART -->
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 471.701 471.701"><path
                                ...
                                <div class="movieTitle">
                                    <h1>{{christmasmovie.title}}</h1>
                                    <p></p>
                                </div>

                                <div class="movieDescription">
                                    <a href="#" class="moreInfoBtn">
                                        {{christmasmovie.overview}}
                                    </a>
                                </div>

                                <div class="movieGenres">
                                    <span class="genre" v-for="genre in christmasmovie.genre_ids" :key="genre.id">{{genre.name}}</span>                               
                                    <!-- <span class="genre" v-for="actor in movie.movie_actor" :key='actor.id'>{{actor.name}}</span> -->
                                    <span class="movieLength">{{christmasmovie.release_date}}</span>
                                </div>
                                            ...
                                            <div class="disclaimer" style="margin-left: 300px;">
                                                ...
                                                <christmas-review-list :christmasreviews="christmasmovie.christmasmovie_review" :christmasmovieid ="christmasmovie.id" style="color:white;"></christmas-review-list>
      ...
      return `https://image.tmdb.org/t/p/w500/${this.christmasmovie.poster_path}`
                                                  ...
                                                  mounted: function () {
                                                    ...
                                                    $(document).ready(function () {
                                                        ...
                                                        function hideMoreText() {
                                                            ...
                                                            $(".checkoutButton").html("PURCHASE &pound;2.99");
                                                        ...
                                                        $(".checkoutButton").on("click", function () {
                                                            if (backButtonAction == "moreText") {
                                                                ...
                                                                $(".checkoutButton").html("PAY NOW &pound;2.99");
                                        ...
                                        <style scoped>
                                            * {
                                            ...
                                            .mobileDisplay .videoPlayer.videoPlayback {
                                                transform: scale(1);
                                            }
                                            .mobileDisplay .videoPlayer:hover ~ .controls.videoPlayback {
                                                opacity: 1;
                                            }
                                            .mobileDisplay .videoPlayer iframe {
                                                transform-origin: 0 0;
                                                transform: rotate(90deg) translateY(-113%) translateX(-0.5%) scale(1.13);
                                            }
                                            .mobileDisplay .mobileInfo {
                                                display: block;
                                                position: absolute;
                                                top: 0;
                                                width: 100%;
                                            ...
                                            .mobileDisplay .controls svg {
                                                height: 100%;
                                                fill: white;
                                                opacity: 0.7;
                                                transition: opacity 0.2s ease-in-out;
                                            }
                                            .mobileDisplay .controls svg:active,
                                            .mobileDisplay .controls svg:hover {
                                                opacity: 1;
                                                cursor: pointer;
                                            }
                                            .mobileDisplay .controls.videoPlayback {
                                                z-index: 101;
                                            ...
                                            .mobileDisplay .controls.videoPlayback:hover {
                                                opacity: 1;
                                            }
                                            .mobileDisplay .movie {
                                                width: 100%;
                                            ...
                                            .mobileDisplay .movie svg:active,
                                            .mobileDisplay .movie svg:hover {
                                                fill: white;
                                                cursor: pointer;
                                            }
                                            .mobileDisplay .movie:before {
                                                content: "";
                                                width: 100%;
                                                display: block;
                                                height: 100%;
                                            ...
                                            .mobileDisplay .movie:after {
                                                content: "";
                                                width: 100%;
                                                display: block;
                                                box-shadow: inset 0 -54px 100px black;
                                                height: 100%;
                                                position: absolute;
                                                top: 0;
                                                z-index: 2;
                                            }
                                            .mobileDisplay .movie.moreTextActive {
                                                padding-top: 35%;
                                            }
                                            .mobileDisplay .movie.moreTextActive .trailerPlayButton {
                                                opacity: 0;
                                            }
                                            .mobileDisplay .movie.checkoutActive {
                                                padding-top: 82%;
                                            }
                                            .mobileDisplay .movie.checkoutActive .trailerPlayButton {
                                                opacity: 0;
                                            }
                                            .movieDetails {
                                                position: absolute;
                                            ...
                                            .movieDetails.moreTextActive {
                                                min-height: 430px;
                                                bottom: 100px;
                                            }
                                            .movieDetails.checkoutActive {
                                                min-height: 340px;
                                            }
                                            ...
                                            .movieDetails .movieRating svg {
                                                width: 30px;
                                                fill: red;
                                                margin-right: 10px;
                                            }
                                            .movieDetails .movieRating .rating {
                                                color: #999;
                                            }
                                            ...
                                            .movieDetails .movieDescription:after {
                                                content: "";
                                                display: block;
                                                width: 100%;
                                                height: 100%;
                                            ...
                                            .movieDetails .movieDescription.checkoutActive {
                                                opacity: 0;
                                            }
                                            .movieDetails .movieDescription.moreTextActive {
                                                max-height: 310px;
                                                overflow-y: scroll;
                                            }
                                            .movieDetails .movieDescription.moreTextActive:after {
                                                opacity: 0;
                                            }
                                            .movieDetails .movieDescription.moreTextActive a:active,
                                            .movieDetails .movieDescription.moreTextActive a:hover {
                                                cursor: initial;
                                            }
                                            .movieDetails .movieDescription.moreTextActive a:active p,
                                            .movieDetails .movieDescription.moreTextActive a:hover p {
                                                color: #999;
                                            }
                                            .movieDetails .movieDescription a {
                                                text-decoration: none;
                                                color: #999;
                                            }
                                            .movieDetails .movieDescription a:active,
                                            .movieDetails .movieDescription a:hover {
                                                cursor: pointer;
                                            }
                                            .movieDetails .movieDescription a:active p,
                                            .movieDetails .movieDescription a:hover p {
                                                color: white;
                                            }
                                            .movieDetails .movieDescription p {
                                            ...
                                            .movieDetails .movieGenres.checkoutActive,
                                            .movieDetails .movieGenres.moreTextActive {
                                                opacity: 0;
                                            }
                                            .movieDetails .movieGenres .genre {
                                                font-size: 12px;
                                                padding: 2px 16px;
                                                color: #999;
                                            ...
                                            .movieDetails .movieGenres .genre:active,
                                            .movieDetails .movieGenres .genre:hover {
                                                background-color: white;
                                                border-color: white;
                                                color: black;
                                                cursor: pointer;
                                            }
                                            .movieDetails .movieGenres .movieLength {
                                                color: white;
                                                font-weight: 300;
                                                font-size: 12px;
                                            }
                                            ...
                                            .checkoutForm .paymentOption > svg {
                                                width: 40px;
                                                fill: white;
                                                display: block;
                                                opacity: 0.4;
                                            ...
                                            .checkoutForm .paymentOption > svg:hover {
                                                cursor: pointer;
                                                opacity: 1;
                                            }
                                            .checkoutForm .paymentOption .paymentSelecion {
                                                width: 130px;
                                                height: 90%;
                                            ...
                                            .checkoutForm .paymentOption .paymentSelecion > div {
                                                display: flex;
                                            ...
                                            .checkoutForm .paymentOption .paymentSelecion > div.active {
                                                transform: translateX(0);
                                                opacity: 1;
                                            }
                                            .checkoutForm .paymentOption .paymentSelecion svg {
                                                width: 35px;
                                                fill: #999;
                                                margin-bottom: 4px;
                                            }
                                            .checkoutForm .paymentOption .paymentSelecion span {
                                                color: white;
                                                letter-spacing: 1.2px;
                                                font-size: 12px;
                                                font-weight: 300;
                                            }
                                            .checkoutForm .paymentOption .paymentSelecion .paymentOptionCreditCard {
                                                transform: translateX(-100%);
                                            }
                                            .checkoutForm .paymentOption .paymentSelecion .paymentOptionPaypal {
                                                position: relative;
                                                top: -100%;
                                                transform: translateX(100%);
                                            }
                                            ...
                                            .checkoutForm > form.creditCardForm {
                                                transform: translateX(calc(-100% - 20px));
                                            }
                                            .checkoutForm > form.payPalForm {
                                                position: relative;
                                                top: -200px;
                                                transform: translateX(calc(100% + 20px));
                                            }
                                            .checkoutForm > form.checkoutActive {
                                                transform: translateX(0);
                                            }
                                            .checkoutForm > form .flipInputs {
                                                display: flex;
                                            ...
                                            .checkoutForm > form .flipInputs > svg {
                                                position: absolute;
                                                width: 25px;
                                                bottom: 10px;
                                                right: 0;
                                            ...
                                            .checkoutForm > form .flipInputs.small {
                                                width: 50%;
                                            }
                                            .checkoutForm > form .flipInputs input {
                                            ...
                                            .checkoutForm > form .flipInputs input:focus {
                                                outline: none;
                                            }
                                            .checkoutForm > form .flipInputs input:focus + label {
                                                color: #00d1b3;
                                            }
                                            .checkoutForm > form .flipInputs input:focus ~ svg {
                                                fill: #00d1b3;
                                            }
                                            .checkoutForm > form .flipInputs label {
                                                transition: color 0.2s ease-in-out;
                                                color: #999;
                                                font-family: 'Open Sans', sans-serif;
                                            }
                                            ...
                                            .disclaimer .designerSocial {
                                                display: flex;
                                                align-items: center;
                                                width: 100%;
                                            }
                                            .disclaimer .designerSocial a {
                                                display: block;
                                                width: calc(100% / 3);
                                                padding: 22px;
                                            }
                                            .disclaimer .designerSocial a img {
                                                width: 100%;
                                            }
                                            .demoButton {
                                                text-decoration: none;
