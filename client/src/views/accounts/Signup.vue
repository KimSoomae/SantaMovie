<template>
  <div>
	...
	<div class="container">
      ...
      <input type="password" placeholder="Password Check" v-model="credentials.passwordConfirmation">
			<button id="login-button" @click="signup">Sign up</button>
		</div>
	</div>
...
.wrapper {
  background: #50a3a2;
  background: linear-gradient(to bottom right, rgb(51, 77, 16) 0%, rgb(51, 77, 16) 100%);
  position: absolute;
  top: 50%;
  left: 0;
  width: 100%;
