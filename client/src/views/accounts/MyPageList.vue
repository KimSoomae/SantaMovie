<template>
  ...
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="https://media-cldnry.s-nbcnews.com/image/upload/newscms/2020_47/1639564/santa-main-khu-201120.jpg" alt="profile card">
    </div>
  ...
  >
    ...
    <v-container fluid>
      <v-row dense>
        <v-col
          v-for="card in likemovies"
          :key="card.id"
          cols=4
        >
        <my-page-card :card="card"></my-page-card>
...
import MyPageCard from '@/views/accounts/MyPageCard.vue'
...
export default {
  ...
  methods: {
    ...
    getLikeMovie: function() {
      axios({
        method: 'get',
        url: 'http://127.0.0.1:8000/accounts/get_like_movie/',
...
.profile-card-loc__txt{
  padding: 5px;
  border: 1px solid rgb(131, 18, 22);
}
...
.wrapper {
  ...
  padding-top: 100px;
  display: flex;
  /* background-image: linear-gradient(-20deg, rgb(219, 32, 38) 0%, rgb(113, 182, 24) 100%); */
  display: flex;
  /* background-image: linear-gradient(-20deg, rgb(219, 32, 38) 0%, rgb(113, 182, 24) 100%); */
}
...
.profile-card__img {
  ...
  position: relative;
  z-index: 4;
  box-shadow: 0px 5px 50px 0px rgb(131, 18, 22), 0px 0px 0px 7px rgba(131, 18, 22, 0.5);
}
